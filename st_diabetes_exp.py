...
#load model
model_directory = r'/content/drive/MyDrive/Colab Notebooks/TesColabDiabetes' ##diisi dengan path folder dimana file dataset berada

# Gunakan os.path.join() untuk menggabungkan direktori dan file model pickle
model_path = os.path.join(model_directory, '/content/drive/MyDrive/Colab Notebooks/TesColabDiabetes/rf_diabetes_model.pkl') 
